...
\code{apps/validate\_gpu} compares the persistent GPU path against the CPU
reference for 30 Trotter steps ($L{=}12$, $\chi_{\max}{=}32$, $dt{=}0.05$,
order~2).  The maximum discrepancy is $3.229\times10^{-13}$.  All 54 unit
tests pass, and 1-, 2-, and 4-rank sweeps match the single-rank results for
the same parameter pairs.
...
pair-processing time over ranks.
